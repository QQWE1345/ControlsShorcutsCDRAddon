...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="06c3296e-15fd-4f86-bbfa-49bfcf79a3a0" noBmpOnMenu="true"
                type="checkButton"
                check="*Docker('a015b360-34c5-44a3-9977-a51d25a90343')"
      ...
      <itemData guid="0ddc6b41-f874-4a1d-8ce7-310a482bf9b0"
                type="wpfhost"
                hostedType="Addons\ControlsShorcutsCDRAddon\ControlsShorcutsCDRAddon.dll,ControlsShorcutsCDRAddon.DockerUI"
                enable="true"/>
  ...
  <xsl:template match="uiConfig/dockers">
    <xsl:copy>
      ...
      <dockerData guid="a015b360-34c5-44a3-9977-a51d25a90343"
                  userCaption="Shortcuts"
                  wantReturn="true"
                  focusStyle="noThrow">
        <container>
          <!-- add the webpage control to the docker -->
          <item dock="fill" margin="0,0,0,0" guidRef="0ddc6b41-f874-4a1d-8ce7-310a482bf9b0"/>
        </container>
      </dockerData>
    </xsl:copy>
  </xsl:template>
